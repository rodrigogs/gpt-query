...
export class ToolExecutor {
    ...
    performSearch(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios.get('https://www.googleapis.com/customsearch/v1', {
                    params: {
                        key: this.apiKey,
                        cx: this.cx,
                        q: query,
    ...
    fetchPageText(url) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios.get(url, { timeout: 5000 }); // Timeout added to prevent long waits
